...
public:
    ...
    bool Initialize(const shared_str& skeleton_path, const shared_str& animations_path);
...
private:
    ...
    MotionID CreateMotionID(const shared_str& name);
    shared_str GetMotionName(MotionID id);
