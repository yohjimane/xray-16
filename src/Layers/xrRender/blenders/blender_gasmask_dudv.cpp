...
void CBlender_gasmask_dudv::Compile(CBlender_Compile& C)
{
    ...
    case 0:
        ...
        break;
    case 1:
        C.r_Pass("stub_screen_space", "gasmask_blur", FALSE, FALSE, FALSE);
        C.r_dx11Texture("s_image", r2_RT_generic0);
        ...
        break;
    case 2:
        C.r_Pass("stub_screen_space", "gasmask_breath", FALSE, FALSE, FALSE);
        C.r_dx11Texture("s_image", r2_RT_generic0);
        C.r_dx11Texture("s_image_blurred", r2_RT_mask_drops_blur);
        C.r_dx11Texture("s_breath_noise", "shaders\\gasmasks\\mask_breath_noise");
        C.r_dx11Texture("s_blur_2", r2_RT_blur_2);
        C.r_dx11Texture("s_blur_4", r2_RT_blur_4);
        C.r_dx11Texture("s_blur_8", r2_RT_blur_8);
